---
title: Course Description for US High School English/Language Arts
description: A detailed course description for a US High School English/Language Arts course aligned with the Common Core State Standards (CCSS-ELA) developed by the National Governors Association (NGA) and the Council of Chief State School Officers (CCSSO), including overview, topics covered, and learning objectives in the format of the 2001 Bloom Taxonomy.
quality_score: 96
---
