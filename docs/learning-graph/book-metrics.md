...
| Concepts | 295 | [Concept List](./concept-list.md) | Concepts from learning graph |
...
| MicroSims | 20 | [Simulations](../sims/index.md) | Interactive MicroSims |
...
| Total Words | 208,279 | 146,408 | Words in markdown files |
| Links | 287 | 51 | Hyperlinks in markdown format |
| Equivalent Pages | 847 | 600 | Estimated pages (250 words/page + visuals) |
