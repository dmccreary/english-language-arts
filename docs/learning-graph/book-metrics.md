...
|---|---------|-------|--------|-------|
| 1 | Concepts | 295 | Required | Concepts from learning graph |
| 2 | Chapters | 17 | Required | Chapter directories with index.md |
| 3 | MicroSims | 21 | Recommended | Interactive simulations in docs/sims/ |
...
| 9 | Words | 263,019 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 18 | 18 | H4 headers starting with '#### Diagram:' |
| Equations | 3 | 0 | LaTeX expressions (inline and display) |
| Total Words | 263,019 | 179,173 | Words in markdown files |
| Links | 448 | 205 | Hyperlinks in markdown format |
| Equivalent Pages | 1067 | 731 | Estimated pages (250 words/page + visuals) |
