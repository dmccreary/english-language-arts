# Learning Graph for US High School English Language Arts
...
This learning graph contains **295 concepts** organized into **13 taxonomy categories**.
...
- Foundational concepts: 1 entry point (English Language Arts Overview)
- Indegree distribution analysis
- Longest dependency chains (max 13 hops)
- Connectivity: all 269 nodes in a single connected component
...
- 12 taxonomy categories covering the five CCSS-ELA strands plus cross-cutting skills
- Category organization — foundational elements first, capstone projects last
- All categories under the 30% threshold (largest: Reading Literature at 25.7%)
...
| Cognitive Bias | BIAS | 18 | 6.1% |
| AI and Writing | AIWR | 14 | 4.7% |
| Research and Citation | RES | 4 | 1.4% |
