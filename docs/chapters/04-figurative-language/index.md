---
title: Figurative Language, Tone, and Author's Style
description: A comprehensive exploration of the language-level choices that distinguish literary writing, covering figurative language (metaphor, simile, personification, hyperbole, irony, symbolism, allusion, motif, imagery), word-level analysis (connotation, denotation, diction), and the way tone, mood, and syntax combine to create an author's distinctive style.
...
14. Mood
15. Author's Style
16. Syntax and Sentence Structure
...
!!! mascot-thinking "Irony Is Not Just Sarcasm"
...
!!! mascot-tip "Tone Words in Your Writing"
...
!!! mascot-encourage "This Takes Practice — and That's Fine"
    <img src="../../img/mascot/encouraging.png" class="mascot-admonition-img" alt="Pip with an encouraging expression">
