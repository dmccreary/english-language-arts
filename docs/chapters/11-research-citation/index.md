---
title: Research, Citation, and Academic Integrity
description: The full research and citation toolkit — evidence integration, research methodology, library and database research, source evaluation, plagiarism, MLA and APA citation formats, annotated bibliography, and synthesizing multiple sources into a sustained research paper.
generated_by: claude skill chapter-content-generator
date: 2026-05-12 12:30:00
version: 0.08
---

# Research, Citation, and Academic Integrity
...
- [Chapter 6: Informational Text: Rhetoric, Argument, and Rhetorical Appeals](../06-informational-text/index.md)
- [Chapter 7: US Foundational Documents and Informational Sources](../07-foundational-documents/index.md)
- [Chapter 8: Critical Thinking, Logical Reasoning, and Fallacies](../08-critical-thinking/index.md)
- [Chapter 9: The Writing Process, Essay Foundations, and Digital Tools](../09-writing-process/index.md)
- [Chapter 10: Writing Modes and Essay Development](../10-writing-modes/index.md)
...
!!! mascot-thinking "Know What Kind of Source You Need Before You Search"
...
- *Journal article*: Last, First. "Title of Article." *Journal Name*, vol. #, no. #, Year, pp. ###–###.
- *Website article*: Last, First. "Title of Page." *Website Name*, Publisher, Date, URL.
...
**Three sources** (summarized):
- Source A (Johnson, 2022, JAMA Pediatrics): Large longitudinal study finding 13% higher depression rates among heavy social media users
- Source B (Williams, 2021, developmental psychology journal): Argues that the relationship is bidirectional — depressed adolescents are more likely to seek connection through social media, which may then increase exposure to content that worsens symptoms
- Source C (Rodriguez, 2023, Surgeon General advisory): Notes that the evidence for harm is "concerning" but calls for more research and platform accountability rather than individual restrictions
